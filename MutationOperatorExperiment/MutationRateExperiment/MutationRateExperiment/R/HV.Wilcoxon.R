  ...
  if (i == j) {
    ...
    if (is.finite(wilcox.test(data1, data2)$p.value) & wilcox.test(data1, data2)$p.value <= 0.05) {
      if (median(data1) >= median(data2)) {
        write("$\\blacktriangle$", "MutationRateExperiment/MutationRateExperiment/R/HV.Wilcoxon.tex", append=TRUE)
      }
      else {
        write("$\\triangledown$", "MutationRateExperiment/MutationRateExperiment/R/HV.Wilcoxon.tex", append=TRUE) 
      }
    }
    else {
      write("$-$", "MutationRateExperiment/MutationRateExperiment/R/HV.Wilcoxon.tex", append=TRUE) 
